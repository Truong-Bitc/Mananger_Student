    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                // Truy vấn dữ liệu từ bảng Classes
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='admin_edit_class.php?id=".$row['class_id']."' class='btn btn-primary'>Edit</a>
                                <a href='process_delete_class.php?id=".$row['class_id']."' class='btn btn-danger' onclick='return confirmDelete();'>Delete</a>
                              </td>";
                        echo "</tr>";
                    }
                } else {
