...
<body>
    ...
    <!-- Script để hiển thị cửa sổ thông báo khi thêm sinh viên thành công -->
    <script>
        // Kiểm tra URL của trang để xác định xem đã thêm sinh viên thành công hay không
        var urlParams = new URLSearchParams(window.location.search);
        if (urlParams.get('success')) {
            // Nếu thành công, hiển thị cửa sổ thông báo
